...
export const KPICard: React.FC<KPICardProps> = ({
	...
	return (
		<div className="p-6 rounded-2xl border transition-all hover:shadow-lg bg-white dark:bg-dark-card border-zinc-200 dark:border-zinc-800">
			...
			<p className="text-3xl font-bold text-zinc-900 dark:text-zinc-100 mb-1">{value}</p>
			{changeLabel && <p className="text-xs text-zinc-400 dark:text-zinc-500">{changeLabel}</p>}
		</div>
	);
};
