...
export const TopProductsChart: React.FC<TopProductsChartProps> = ({ data }) => {
	return (
		<div className="p-6 rounded-2xl border bg-white dark:bg-dark-card border-zinc-200 dark:border-zinc-800">
			<div className="mb-6">
				<h3 className="text-lg font-bold text-zinc-900 dark:text-zinc-100 mb-1">Top 5 Productos</h3>
				<p className="text-sm text-zinc-500 dark:text-zinc-400">Más vendidos este mes</p>
			</div>
			<ResponsiveContainer width="100%" height={300}>
				<BarChart data={data} layout="vertical">
					...
					/>
					<Bar dataKey="sales" fill="#317eebff" radius={[0, 8, 8, 0]} />
				</BarChart>
			</ResponsiveContainer>
		</div>
	);
