			...
			>
				<CardBody className="flex flex-row gap-3">
					<div className="flex flex-col gap-3 w-full">
						<Input
							label="Nombre"
							placeholder="Ej: Coordinar pago por WhatsApp"
							value={form.name ?? ''}
						...
						<Input
							...
							value={form.details?.number_whatsapp ?? ''}
							onChange={(e) => handleChange(e, 'details', 'number_whatsapp')}
							classNames={{
								label: 'text-black/50 dark:text-white/90',
								innerWrapper: 'bg-transparent',
								input: [
						...
						<Textarea
							...
							onChange={(e) => handleChange(e, 'details', 'description')}
							classNames={{
								label: 'text-black/50 dark:text-white/90',
								innerWrapper: 'bg-transparent',
								input: [
