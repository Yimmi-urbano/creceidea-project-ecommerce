                    ...
                    {menuItems.map((item) => {
                        ...
                        return (
                            <Link
                                key={item.href}
                                href={item.href}
                                className={`flex-1 flex flex-col items-center justify-center p-2 rounded-xl transition-all duration-300 group ${active
                                    ? 'text-primary'
                            ...
                            >
                                ...
                                <span className={`text-[10px] font-semibold mt-1.5 transition-all duration-300 ${active
                                    ? 'text-primary'
