...
const Sidebar = (): React.ReactElement => {
	...
	return (
		<>
			<aside
				className={`fixed top-0 left-0 z-40 h-screen transition-all duration-300 ease-in-out border-r flex flex-col bg-white dark:bg-dark-card border-zinc-200 dark:border-zinc-800 ${
			...
			>
				...
				<div className="p-4 border-t shrink-0 border-zinc-200 dark:border-zinc-800">
					<UserButton isCollapsed={isCollapsed} showFullInfo />
				</div>
