					...
					<div className="max-w-md w-full relative">
						<div className="bg-white/90 dark:bg-dark-card/90 backdrop-blur-xl rounded-[2.5rem] shadow-2xl border border-white/20 dark:border-zinc-800 p-10 lg:p-12 overflow-hidden">
							...
							<div className="flex justify-center mb-8 relative">
								<div
									className={`p-6 rounded-3xl shadow-lg transition-all duration-500 ${isSessionError ? 'bg-amber-100 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400' : 'bg-rose-100 dark:bg-rose-900/30 text-rose-600 dark:text-rose-400'}`}
								>
						...
						<p className="text-center text-sm text-zinc-400 dark:text-zinc-500 mt-8 font-medium">
							...
							<span className="text-primary hover:underline cursor-pointer">soporte técnico</span>
						</p>
					</div>
				</div>
			);
