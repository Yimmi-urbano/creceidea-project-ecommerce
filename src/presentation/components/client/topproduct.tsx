...
const TopProductComponent: React.FC = () => {
	...
	return (
		<Card
			isBlurred
			className="md:flex hidden border-1 border-teal-100 bg-teal-200/60 dark:bg-teal-300/40 dark:border-teal-200 max-w-[610px]"
		>
			<CardBody>
				<div className="text-white flex flex-col items-center">
					...
					<Button
						...
						variant="solid"
						endContent={<EyeIcon />}
						className="bg-white text-black m-auto block w-[80%] flex rounded-3xl"
					>
						Ver producto
					</Button>
				</div>
