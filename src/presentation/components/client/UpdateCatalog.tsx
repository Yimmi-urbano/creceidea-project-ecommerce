...
const UpdateCatalogForm: React.FC = () => {
	...
	return (
		<>
			<Card
				shadow="none"
				className="h-full border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 w-full"
			>
				...
				<CardBody className="gap-6 p-6">
					...
					<div className="space-y-4">
						<h3 className="text-md font-semibold text-zinc-900 dark:text-zinc-200">
							Botón de Acción
						</h3>
					...
					<div className="space-y-4">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
							<Select
								...
								labelPlacement="outside"
								selectedKeys={
									selectedCurrency.code ? new Set([selectedCurrency.code]) : new Set([])
								}
