...
} from '@/src/application/banners/bannerServices';
		...
		>
			<ModalContent>
							...
							>
								{uploadingImage ? (
									<>
										...
										<p className="text-sm text-zinc-600 dark:text-zinc-400">Subiendo imagen...</p>
									</>
								) : (
									<>
						...
						<div className="space-y-5 pt-2">
							...
							<div className="space-y-2">
								...
								<Input
									...
									classNames={{
										inputWrapper:
											'border-zinc-300 dark:border-zinc-700 group-data-[focus=true]:border-primary',
									}}
								/>
								<p className="text-xs text-zinc-500 dark:text-zinc-400">
				...
				<ModalFooter className="border-t border-zinc-200 dark:border-zinc-800 pt-4">
					<Button variant="flat" onPress={handleClose} disabled={loading} className="font-medium">
						Cancelar
					</Button>
					<Button
						color="primary"
