			...
			<div className="flex justify-between items-center mb-6">
				<div>
					...
					<p className="text-sm text-zinc-500">
						Conecta tus perfiles para que tus clientes te encuentren.
					</p>
				</div>
				<Button
					color="primary"
								...
								<div className="flex items-center gap-3">
									<div className="p-2 rounded-lg bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400">
										...
										<span className="font-bold text-sm">
											{link.icon.substring(0, 2).toUpperCase()}
										</span>
									</div>
				...
				<ModalContent>
					...
					<ModalBody>
						<p className="text-zinc-600 dark:text-zinc-400">
							Esta acción eliminará el enlace permanentemente de tu tienda. ¿Estás seguro de
							continuar?
						</p>
					</ModalBody>
					<ModalFooter>
