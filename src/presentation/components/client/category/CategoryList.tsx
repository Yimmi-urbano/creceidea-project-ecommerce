...
const CategoryList: React.FC = () => {
	const { categories, allCategories, message, handleUpdateCategory, handleDeleteCategory } =
		useCategoryContext();
	...
	const renderCategory = (category: Category) => (
		<div key={category._id} style={{ marginBottom: '10px' }}>
			<Card
				isBlurred
				className="w-full rounded-lg justify-between flex flex-row border-1 border-sky-200/30 bg-sky-300"
			>
				<CardBody>
	...
	return (
		<div>
			...
			<Modal
				...
				className="backdrop-blur-md border-1 border-sky-200/20 bg-sky-700/40"
			>
				<ModalContent>
					...
					<ModalBody>
						...
						{selectedParent && (
							<Button color="danger" variant="flat" onClick={clearSelection}>
								Limpiar selección
							</Button>
						)}
						<Spacer y={1} />
