			...
			<div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
				<div className="flex flex-col gap-1">
					<Breadcrumbs size="sm" className="mb-1">
						...
						<BreadcrumbItem>Crear Nuevo</BreadcrumbItem>
					</Breadcrumbs>
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
								<div>
									...
									<Input
										...
										classNames={{
											inputWrapper:
												'shadow-sm border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-900 group-data-[focus=true]:border-primary',
										}}
									/>
								</div>
								<div>
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
								<div>
									...
									<p className="text-xs text-zinc-500 mt-2 ml-1">
										Selecciona una o más categorías para tu producto.
									</p>
								</div>
									...
									<div className="flex items-center justify-between p-4 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/30">
										...
										<Switch
											...
											onValueChange={(isSelected) =>
												setFormData({ ...formData, visible: isSelected })
											}
											color="primary"
											size="lg"
										/>
					...
					<Card className="bg-primary/5 border border-primary/20 shadow-none">
						<CardBody className="p-4 flex flex-row items-start gap-3">
							...
							<div className="text-sm text-zinc-600 dark:text-zinc-300">
								...
								Asegúrate de incluir buenas imágenes y una descripción detallada para aumentar la
								conversión.
							</div>
						</CardBody>
					</Card>
