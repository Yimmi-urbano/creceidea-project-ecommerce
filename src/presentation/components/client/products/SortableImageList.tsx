...
function SortableImageItem({ url, index, onRemove }: SortableImageItemProps) {
	...
	const style: React.CSSProperties = useMemo(() => {
		...
		return {
			...
			transition: isDragging ? 'none' : shouldAnimate && transition ? transition : undefined,
	...
	return (
		...
		>
			...
			<div className="absolute top-2 left-2 z-20 bg-black/50 hover:bg-black/70 rounded-lg p-2 pointer-events-none">
...
export default function SortableImageList({ images, onRemove, onReorder }: SortableImageListProps) {
