...
const NotificationModal: React.FC<NotificationModalProps> = ({
	...
	return (
		<Modal
			isOpen={isOpen}
			onClose={onClose}
			className="backdrop-blur-sm border-1 border-sky-200/20 bg-sky-700/80"
		>
			<ModalContent>
				<ModalBody>{isLoading ? <Spinner size="lg" /> : <p>{message}</p>}</ModalBody>
			</ModalContent>
		</Modal>
	);
};
	...
	return (
		...
		>
			<ModalContent>
				...
				<ModalBody>
					<p>
						Este tema requiere pago previo. Por favor, realiza el pago a uno de los siguientes
						números de cuenta:
					</p>
