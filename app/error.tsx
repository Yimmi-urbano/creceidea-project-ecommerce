...
export default function Error({
  ...
  const isContextError = error.message?.includes('useContext') || error.message?.includes('Context')
  const isSessionError = isContextError && typeof window !== 'undefined' && !localStorage.getItem('domainSelect')
