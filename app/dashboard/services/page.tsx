...
const SERVICES_DATA: Service[] = [
	{
		...
		detail: 'restaurante-ejemplo.com',
		type: 'domain',
		status: 'active',
		expiry: '25 Nov 2025',
		icon: Globe,
		...
		<div className="space-y-6 animate-in fade-in duration-500">
			...
			<div className="p-6 rounded-2xl border flex items-center gap-6 bg-blue-50 dark:bg-blue-900/10 border-blue-100 dark:border-blue-900/30">
				...
				<div>
					...
					<p className="text-sm text-zinc-500 dark:text-zinc-400">
						Puedes escalar tu servidor o adquirir nuevos dominios directamente desde el panel de
						soporte.
					</p>
				</div>
