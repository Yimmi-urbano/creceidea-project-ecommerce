		...
		try {
			...
			if (response.status === 'error') {
				...
				localStorage.setItem(
					...
					JSON.stringify(response.data.user.components)
				);
			...
			<div className="w-full max-w-5xl flex flex-col lg:flex-row shadow-2xl rounded-3xl overflow-hidden">
				...
				<div className="hidden lg:flex lg:w-[45%] relative overflow-hidden">
					...
					<div
						...
						style={{
							backgroundImage:
								'url(https://media-static.creceidea.pe/images/background-creceidea.jpg)',
						}}
					/>
					...
					<div className="absolute inset-0">
						<div className="absolute top-[-30%] left-[-30%] w-72 h-72 rounded-full bg-white/10 blur-3xl animate-pulse" />
						<div
							className="absolute bottom-[-30%] right-[-30%] w-72 h-72 rounded-full bg-white/10 blur-3xl animate-pulse"
					...
					<div className="relative z-10 flex flex-col justify-center items-center w-full px-10 py-16 text-white">
						...
						{/* Tagline */}
						<p className="text-base text-white/90 mb-8 font-light">Tus ideas, tu éxito</p>
						...
						<form onSubmit={handleSubmit} className="space-y-5">
							...
							<div className="space-y-1.5">
								...
								<Input
									...
									classNames={{
										inputWrapper:
											'bg-zinc-50 dark:bg-zinc-900 border-zinc-200 dark:border-zinc-700 hover:border-primary dark:hover:border-primary data-[hover=true]:border-primary group-data-[focus=true]:border-primary',
