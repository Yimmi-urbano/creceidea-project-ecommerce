				...
				<div className="w-full max-w-md">
					<div className="bg-dark-card rounded-2xl p-8 border border-dark-border text-center">
						...
						<p className="text-zinc-400 mb-6">
							Tu cuenta ha sido creada exitosamente. Hemos enviado un correo de verificación a{' '}
		...
		<div className="min-h-screen bg-dark-bg flex items-center justify-center p-4">
			<div className="w-full max-w-md">
				...
				<div className="bg-dark-card rounded-2xl p-8 border border-dark-border">
					...
					<p className="text-zinc-400 mb-8">Comienza a gestionar tu negocio hoy mismo</p>
