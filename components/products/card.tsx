...
const CardProducts: React.FC = () => {
  ...
  return (
    <div className="flex flex-wrap gap-4">
      ...
      {products.map((item) => (
        <Card key={item._id} className="w-full rounded-lg flex flex-row border-1 border-[#0c78ad5c] bg-background/70 dark:bg-sky-950/30">
          <div className="flex items-center gap-4 p-2 flex-grow">
            <img src={item.image_default[0]} alt={item.title} className="w-16 h-16 border-1 border-[#0c78ad5c] rounded-xl object-cover" />
            <div>
          ...
          <div className="flex flex-col justify-center items-center gap-2 pr-2">
