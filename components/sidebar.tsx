...
const Sidebar: React.FC = () => {
  ...
  return (
    <Card isBlurred id="sidebar" ref={sidebarRef} className="resizable border-1 border-[#41B4F1CC]/80 bg-[#4595C0] dark:bg-sky-950/30 dark:text-white  p-4 relative flex flex-col items-center">
