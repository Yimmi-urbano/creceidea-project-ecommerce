...
const Sidebar: React.FC = () => {
  ...
  return (
    <div id="sidebar" ref={sidebarRef} className="resizable text-white p-4 relative">
      <Logo className='logo-sidebar mb-10 mt-5 ml-[-9px]' />
      <Options />
      <div id="resize-handle" ref={resizeHandleRef} className="resize-handle text-gray-200">
